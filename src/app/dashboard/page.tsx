...
const DashboardView = () => {
	...
	return (
		<main className='flex h-screen text-white'>
			<section className='w-1/4 bg-principal-blue flex items-center justify-center'>
				<div className='font-extralight text-9xl leading-tight whitespace-pre-line text-center ml-5'>
					Bienv{"\n"}enido{"\n"}de{"\n"}nuevo
				</div>
			</section>

			<section className='w-3/4 bg-secondary-blue mt-30 ml-10 p-8 rounded-tl-[50px] overflow-y-auto'>
