    ...
    return (
        <section className="relative w-full bg-principal-blue text-white py-20 px-6">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <h1 className="text-5xl font-extrabold mb-6">Suscripción PREMIUM</h1>
                <p className="text-lg max-w-3xl mx-auto mb-16">
                    Potencia tu experiencia en ByCarket con beneficios exclusivos pensados
                    para vendedores profesionales y usuarios que quieren lo mejor.
                </p>
