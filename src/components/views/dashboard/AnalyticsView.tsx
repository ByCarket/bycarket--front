...
export default function AnalyticsView() {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-t  p-10 text-gray-800 font-sans">
            <h1 className="text-4xl font-bold mb-8 text-center">Panel de Analíticas</h1>
            ...
            {/* Line Chart - Favoritos */}
            <div className="bg-white rounded-xl p-6 shadow max-w-5xl mx-auto mb-10">
                <h3 className="text-lg font-semibold text-gray-700 mb-4">Crecimiento de Favoritos</h3>
                <ResponsiveContainer width="100%" height={250}>
            ...
            {/* Bar Chart - Interacciones */}
            <div className="bg-white rounded-xl p-6 shadow max-w-5xl mx-auto mb-10">
                <h3 className="text-lg font-semibold text-gray-700 mb-4">Interacciones por Mes</h3>
                <ResponsiveContainer width="100%" height={250}>
