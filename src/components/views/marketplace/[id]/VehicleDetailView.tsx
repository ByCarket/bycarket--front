		...
		<div className="min-h-screen bg-gray-50 text-gray-900 py-12 px-4">
			<div className="max-w-6xl mx-auto space-y-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-[3fr_1.5fr] gap-8 items-start">
					...
					<div className="space-y-6">
						...
						<div className="bg-gradient-to-r from-gray-100 to-white rounded-xl shadow-md p-6 text-center md:text-left">
							...
							<p className="text-lg text-secondary-blue mt-2">{vehicle.version?.name}</p>
						</div>

						{/* Características */}
						<div className="bg-gradient-to-r from-gray-100 to-white rounded-xl shadow-md p-6">
							<h2 className="text-2xl font-semibold text-principal-blue mb-4">Características</h2>
							<ul className="space-y-2 text-base">
								<li><strong className="text-principal-blue">Año:</strong> {vehicle.year}</li>
								<li>
									<strong className="text-principal-blue">Condición:</strong>{" "}
									{vehicle.condition === "used" ? "Usado" : vehicle.condition === "new" ? "Nuevo" : vehicle.condition}
								</li>
								<li><strong className="text-principal-blue">Tipo:</strong> {vehicle.typeOfVehicle}</li>
								<li><strong className="text-principal-blue">Kilometraje:</strong> {vehicle.mileage.toLocaleString()} km</li>
							</ul>
						</div>

						{/* Precio */}
						<div className="bg-gradient-to-r from-gray-100 to-white rounded-xl shadow-md p-4 flex items-center justify-between gap-4">
							<h2 className="text-2xl font-semibold text-principal-blue ml-2">Precio</h2>
				...
				<div className="bg-gradient-to-r from-gray-100 to-white rounded-xl shadow-md p-6 mt-8 max-w-6xl mx-auto">
					<h1 className="text-xl font-semibold mb-4 text-principal-blue">Descripción</h1>
